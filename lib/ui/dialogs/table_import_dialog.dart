...
Future<Grafo?> showAdjacencyMatrixImportDialog(BuildContext context) {
  return showDialog<Grafo>(
    context: context,
    builder: (_) => const AdjacencyMatrixImportDialog(),
  );
}

class AdjacencyMatrixImportDialog extends StatefulWidget {
  const AdjacencyMatrixImportDialog({super.key});

  @override
  State<AdjacencyMatrixImportDialog> createState() =>
      _AdjacencyMatrixImportDialogState();
}

class _AdjacencyMatrixImportDialogState
    extends State<AdjacencyMatrixImportDialog> {
