...
class JohnsonActivityInputDialog extends ConsumerStatefulWidget {
  const JohnsonActivityInputDialog({super.key});

  static Future<void> show(BuildContext context) {
    return showDialog<void>(
      context: context,
      barrierDismissible: false,
      builder: (ctx) => const JohnsonActivityInputDialog(),
    );
  }

  @override
  ConsumerState<JohnsonActivityInputDialog> createState() =>
      _JohnsonActivityInputDialogState();
}

class _JohnsonActivityInputDialogState
    extends ConsumerState<JohnsonActivityInputDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final nodes = grafo.nodos.values.toList();
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Edición de Matriz de Actividades de Johnson',
                          ...
                          Text(
                            'Edita duraciones y precedencias de conexiones existentes',
              ...
              if (nodes.isEmpty)
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Agregue nodos al lienzo para ver la lista de actividades.',
                ...
                Flexible(
                  child: _buildConnectionListView(context, grafo, nodes),
                ),
              Divider(height: 1, color: colorScheme.outlineVariant),
              // Footer
              Container(
  ...
  Widget _buildConnectionListView(
    ...
    for (final orig in nodes) {
      for (final dest in nodes) {
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'No hay conexiones creadas en el lienzo.',
              textAlign: TextAlign.center,
